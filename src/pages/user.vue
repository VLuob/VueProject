<template>
    <div class="content">
  <div class="header">
    <h2><img :src="baseUrl + user.icon" alt="" style="border-radius:.1rem"/></h2>
    <div class="user-box">
      <a class="ni">{{user.nikename}}</a>
...
.content .header{width:6.4rem;height:3.2rem; background:#9e9a95; padding-top:0.4rem;}
.header h2{width:1.02rem;height:auto; border-radius:50%; margin:0 auto;}
.header h2 img{width:100%;}
.header .user-box{width:100%; font-size:0.25rem; color:#fff; margin:0 auto;text-align:center; margin-top:0.2rem;}
.user-box a{color:#fff;}
.user-box a.ni{margin-right:.3rem}
...
.content .docList{width:6.4rem; margin:0 auto;border-top:1px solid #7b7c7c;margin-top:.01rem}
