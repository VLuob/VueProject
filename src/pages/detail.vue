<template>
  <div class="detail" v-if='detail._id'>
    <div class="nav">
  <ul>
...
<div class="content">
  <div class="header clear"><h2><img :src="baseUrl + detail.detail.icon" alt=""/></h2><p>{{detail.detail.auth}}</p></div>
  <div class="cont">
    <h3>{{detail.title}}</h3>
    <div class="time"><p>{{detail.time |data}}/ {{8 | fillzero}}<span><img src="../assets/img/zan.png" alt=""/></span></p></div>
...
html,body{ overflow-x: hidden; }
    ...
    .header img{height:1rem;width:1rem;border-radius: .2rem;box-shadow: 0 0 5rem;}
